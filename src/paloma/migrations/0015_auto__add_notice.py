...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('paloma', ['Notice'])


    def backwards(self, orm):
        # Deleting model 'Notice'
        db.delete_table('paloma_notice')
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'YYv3GG3B3a4rpJQHSPIucjS9MZFyI0pc'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'UBPJ8j6n'", 'unique': 'True', 'max_length': '10'})
        },
        'paloma.group': {
