...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.dt_created'
        db.alter_column('paloma_journal', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'Schedule.task'
        db.add_column('paloma_schedule', 'task',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Journal.dt_created'
        db.alter_column('paloma_journal', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Schedule.task'
        db.delete_column('paloma_schedule', 'task')
