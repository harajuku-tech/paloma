...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('paloma_schedule', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=24, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.status'
        db.delete_column('paloma_schedule', 'status')
