...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paloma_emailtask', (
        ...
        db.send_create_signal('paloma', ['EmailTask'])


    def backwards(self, orm):
        # Deleting model 'EmailTask'
        db.delete_table('paloma_emailtask')
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'dAV6TL1ubGvpjNltBmtXkNShWCX4k9rG'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'Ec64pspu'", 'unique': 'True', 'max_length': '10'}),
