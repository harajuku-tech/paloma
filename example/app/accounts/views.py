...
class SignUpMailView(FormView):
    ''' Sign Up via Email
    '''
    template_name = "accounts/signup/mail.html" 
...
class SignUpWebView(FormView):
    ''' Sign Up via Web 
    '''
    template_name = "accounts/signup/web/default.html" 
    ...
    def post(self, request, **kwargs):
        ...
        if request.POST.has_key('preview'):
            ...
            self.template_name = "accounts/signup/web/preview.html" 
            self.command="preview"
        elif request.POST.has_key('reedit'): 
            self.form_class = SignUpWebForm
            self.template_name = "accounts/signup/web/default.html" 
            self.command="reedit"
        elif request.POST.has_key('commit'):
            self.template_name = "accounts/signup/web/commit.html" 
            self.command="commit"
...
def signup_form(request):
    ''' signup via web form
    '''
    return render_to_response("accounts/signup/form.html",
                        {},
                        context_instance=template.RequestContext(request),)
