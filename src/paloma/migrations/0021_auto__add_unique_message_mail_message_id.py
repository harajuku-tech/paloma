...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Message', fields ['mail_message_id']
        db.delete_unique('paloma_message', ['mail_message_id'])

        # Removing index on 'Message', fields ['mail_message_id']
        db.delete_index('paloma_message', ['mail_message_id'])
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'uggqBH2wjhtPkmS7oVKDXtHEGT767iRa'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'2KYmK91J'", 'unique': 'True', 'max_length': '10'}),
