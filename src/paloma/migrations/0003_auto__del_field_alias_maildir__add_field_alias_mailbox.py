...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Alias.maildir'
        db.delete_column('paloma_alias', 'maildir')

        # Adding field 'Alias.mailbox'
        db.add_column('paloma_alias', 'mailbox', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Alias.maildir'
        db.add_column('paloma_alias', 'maildir', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Alias.mailbox'
        db.delete_column('paloma_alias', 'mailbox')
