...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Alias.goto'
        db.delete_column('paloma_alias', 'goto')

        # Adding field 'Alias.alias'
        db.add_column('paloma_alias', 'alias', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Alias.goto'
        db.add_column('paloma_alias', 'goto', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Alias.alias'
        db.delete_column('paloma_alias', 'alias')
