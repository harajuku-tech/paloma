...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enroll.group'
        db.add_column('paloma_enroll', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['paloma.Group'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enroll.group'
        db.delete_column('paloma_enroll', 'group_id')
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'O1J3TX8oUNLtw8BNcx6hwoQfRfAsu1Gp'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'ehwaev1X'", 'unique': 'True', 'max_length': '10'})
        },
        'paloma.group': {
