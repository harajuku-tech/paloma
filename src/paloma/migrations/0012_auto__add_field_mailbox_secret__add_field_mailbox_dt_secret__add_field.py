...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('paloma_mailbox', 'secret',
                      self.gf('django.db.models.fields.CharField')(default='Dubh3hR4aPs7El02OJHgo0eAYpyC4Li2', max_length=100),
                      keep_default=False)
        ...
        db.alter_column('paloma_mailbox', 'address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Mailbox.address'
        raise RuntimeError("Cannot reverse this migration. 'Mailbox.address' and its values cannot be restored.")
    ...
    models = {
        ...
        'paloma.mailbox': {
            ...
            'dt_secret': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'uAf5nC9kXAdDU2FFe7LB5SXWBHHWxB4I'", 'max_length': '100'}),
