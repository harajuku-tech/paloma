...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enroll.enroll_type'
        db.add_column('paloma_enroll', 'enroll_type',
                      self.gf('django.db.models.fields.CharField')(default='activate', max_length=24, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enroll.enroll_type'
        db.delete_column('paloma_enroll', 'enroll_type')
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'Jtvbb2eJvBoCM5RSOrit2GEhxrn8bQqE'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'jmvF2q67'", 'unique': 'True', 'max_length': '10'})
        },
        'paloma.group': {
