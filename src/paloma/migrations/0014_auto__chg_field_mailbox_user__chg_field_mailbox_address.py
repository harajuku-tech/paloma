...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Mailbox.address'
        db.alter_column('paloma_mailbox', 'address', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'sn6cxNFwuGCrJkkIeLd5HAlB5GM8QdUu'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'ouimVXXM'", 'unique': 'True', 'max_length': '10'})
        },
        'paloma.group': {
