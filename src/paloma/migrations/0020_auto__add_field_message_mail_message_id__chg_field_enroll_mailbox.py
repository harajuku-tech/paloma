...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.mail_message_id'
        db.add_column('paloma_message', 'mail_message_id',
                      self.gf('django.db.models.fields.CharField')(default='2012-09-03 04:52:14.310201+09:00', max_length=100),
                      keep_default=False)


        # Changing field 'Enroll.mailbox'
        db.alter_column('paloma_enroll', 'mailbox_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['paloma.Mailbox'], unique=True))

    def backwards(self, orm):
        # Deleting field 'Message.mail_message_id'
        db.delete_column('paloma_message', 'mail_message_id')


        # Changing field 'Enroll.mailbox'
        db.alter_column('paloma_enroll', 'mailbox_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['paloma.Mailbox'], unique=True, null=True))
    ...
    models = {
        ...
        'paloma.enroll': {
            ...
            'mailbox': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['paloma.Mailbox']", 'blank': 'True', 'unique': 'True'}),
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'2X0sAbSDjC6tntF3HZmoV1QQclrCRDFa'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'JaDj8iOl'", 'unique': 'True', 'max_length': '10'}),
        ...
        'paloma.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail_message_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
