...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schedule.forward_to'
        db.add_column('paloma_schedule', 'forward_to', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schedule.forward_to'
        db.delete_column('paloma_schedule', 'forward_to')
