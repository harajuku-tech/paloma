...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Jail'
        db.delete_table('paloma_jail')

        # Adding model 'Journal'
        db.create_table('paloma_journal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('receipient', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('paloma', ['Journal'])


    def backwards(self, orm):
        
        # Adding model 'Jail'
        db.create_table('paloma_jail', (
            ('text', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('receipient', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('paloma', ['Jail'])

        # Deleting model 'Journal'
        db.delete_table('paloma_journal')
    ...
    models = {
        ...
        'paloma.journal': {
            ...
            'receipient': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
